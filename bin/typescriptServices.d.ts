...
declare module TypeScript {
    enum SyntaxKind {
        ...
        LessThanToken = 81,
        GreaterThanToken = 82,
        LessThanEqualsToken = 83,
        GreaterThanEqualsToken = 84,
        EqualsEqualsToken = 85,
        EqualsGreaterThanToken = 86,
        ExclamationEqualsToken = 87,
        EqualsEqualsEqualsToken = 88,
        ExclamationEqualsEqualsToken = 89,
        PlusToken = 90,
        MinusToken = 91,
        AsteriskToken = 92,
        PercentToken = 93,
        PlusPlusToken = 94,
        MinusMinusToken = 95,
        LessThanLessThanToken = 96,
        GreaterThanGreaterThanToken = 97,
        GreaterThanGreaterThanGreaterThanToken = 98,
        AmpersandToken = 99,
        BarToken = 100,
        CaretToken = 101,
        ExclamationToken = 102,
        TildeToken = 103,
        AmpersandAmpersandToken = 104,
        BarBarToken = 105,
        QuestionToken = 106,
        ColonToken = 107,
        EqualsToken = 108,
        PlusEqualsToken = 109,
        MinusEqualsToken = 110,
        AsteriskEqualsToken = 111,
        PercentEqualsToken = 112,
        LessThanLessThanEqualsToken = 113,
        GreaterThanGreaterThanEqualsToken = 114,
        GreaterThanGreaterThanGreaterThanEqualsToken = 115,
        AmpersandEqualsToken = 116,
        BarEqualsToken = 117,
        CaretEqualsToken = 118,
        SlashToken = 119,
        SlashEqualsToken = 120,
        SourceUnit = 121,
        QualifiedName = 122,
        ObjectType = 123,
        FunctionType = 124,
        ...
        InExpression = 202,
        OfExpression = 203,
        LeftShiftExpression = 204,
        SignedRightShiftExpression = 205,
        UnsignedRightShiftExpression = 206,
        MultiplyExpression = 207,
        DivideExpression = 208,
        ModuloExpression = 209,
        AddExpression = 210,
        SubtractExpression = 211,
        PostIncrementExpression = 212,
        PostDecrementExpression = 213,
        MemberAccessExpression = 214,
        InvocationExpression = 215,
        ArrayLiteralExpression = 216,
        ObjectLiteralExpression = 217,
        ObjectCreationExpression = 218,
        ParenthesizedExpression = 219,
        ParenthesizedArrowFunctionExpression = 220,
        SimpleArrowFunctionExpression = 221,
        CastExpression = 222,
        ElementAccessExpression = 223,
        FunctionExpression = 224,
        OmittedExpression = 225,
        VariableDeclaration = 226,
        VariableDeclarator = 227,
        ArgumentList = 228,
        ParameterList = 229,
        TypeArgumentList = 230,
        TypeParameterList = 231,
        ExtendsHeritageClause = 232,
        ImplementsHeritageClause = 233,
        EqualsValueClause = 234,
        CaseSwitchClause = 235,
        DefaultSwitchClause = 236,
        ElseClause = 237,
        CatchClause = 238,
        FinallyClause = 239,
        TypeParameter = 240,
        Constraint = 241,
        SimplePropertyAssignment = 242,
        FunctionPropertyAssignment = 243,
        Parameter = 244,
        EnumElement = 245,
        TypeAnnotation = 246,
        ExternalModuleReference = 247,
        ModuleNameModuleReference = 248,
        Last = 248,
        FirstStandardKeyword = 15,
        LastStandardKeyword = 44,
        FirstFutureReservedKeyword = 45,
        LastFutureReservedKeyword = 51,
        FirstFutureReservedStrictKeyword = 52,
        LastFutureReservedStrictKeyword = 60,
        FirstTypeScriptKeyword = 61,
        LastTypeScriptKeyword = 70,
        FirstKeyword = 15,
        LastKeyword = 70,
        FirstToken = 9,
        LastToken = 120,
...
declare module TypeScript {
    ...
    class ForInStatement extends AST {
        ...
        public expression: AST;
        public statement: AST;
        public inOrOf: ISyntaxToken;
        constructor(variableDeclaration: VariableDeclaration, left: AST, expression: AST, statement: AST, inOrOf: ISyntaxToken);
        public kind(): SyntaxKind;
